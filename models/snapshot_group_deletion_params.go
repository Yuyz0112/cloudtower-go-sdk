...
func (m *SnapshotGroupDeletionParams) validateID(formats strfmt.Registry) error {
...
// ContextValidate validates this snapshot group deletion params based on context it is used
