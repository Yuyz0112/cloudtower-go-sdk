...
type ReportTemplateUpdationParamsData struct {
	...
	// execute plan
	ExecutePlan []*ReportTemplateUpdationParamsDataExecutePlanItems0 `json:"execute_plan"`

	// name
	Name string `json:"name,omitempty"`

	// resource meta
	ResourceMeta []*ReportTemplateUpdationParamsDataResourceMetaItems0 `json:"resource_meta"`
}
