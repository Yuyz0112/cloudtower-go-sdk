...
type IscsiLunWhereInput struct {
	...
	// lun id gt
	LunIDGt *float64 `json:"lun_id_gt,omitempty"`

	// lun id gte
	LunIDGte *float64 `json:"lun_id_gte,omitempty"`

	// lun id in
	LunIDIn []float64 `json:"lun_id_in,omitempty"`

	// lun id lt
	LunIDLt *float64 `json:"lun_id_lt,omitempty"`

	// lun id lte
	LunIDLte *float64 `json:"lun_id_lte,omitempty"`

	// lun id not
	LunIDNot *float64 `json:"lun_id_not,omitempty"`

	// lun id not in
	LunIDNotIn []float64 `json:"lun_id_not_in,omitempty"`
