...
type SvtImageWhereInput struct {
	...
	// version gt
	VersionGt *float64 `json:"version_gt,omitempty"`

	// version gte
	VersionGte *float64 `json:"version_gte,omitempty"`

	// version in
	VersionIn []float64 `json:"version_in,omitempty"`

	// version lt
	VersionLt *float64 `json:"version_lt,omitempty"`

	// version lte
	VersionLte *float64 `json:"version_lte,omitempty"`

	// version not
	VersionNot *float64 `json:"version_not,omitempty"`

	// version not in
	VersionNotIn []float64 `json:"version_not_in,omitempty"`
