...
type VMNicWhereInput struct {
	...
	// model not
	ModelNot interface{} `json:"model_not,omitempty"`
	...
	// order gt
	OrderGt *float64 `json:"order_gt,omitempty"`

	// order gte
	OrderGte *float64 `json:"order_gte,omitempty"`

	// order in
	OrderIn []float64 `json:"order_in,omitempty"`

	// order lt
	OrderLt *float64 `json:"order_lt,omitempty"`

	// order lte
	OrderLte *float64 `json:"order_lte,omitempty"`

	// order not
	OrderNot *float64 `json:"order_not,omitempty"`

	// order not in
	OrderNotIn []float64 `json:"order_not_in,omitempty"`
