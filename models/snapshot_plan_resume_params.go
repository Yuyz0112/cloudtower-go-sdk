...
func (m *SnapshotPlanResumeParams) validateID(formats strfmt.Registry) error {
...
// ContextValidate validates this snapshot plan resume params based on context it is used
