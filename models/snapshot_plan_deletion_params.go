...
func (m *SnapshotPlanDeletionParams) validateID(formats strfmt.Registry) error {
...
// ContextValidate validates this snapshot plan deletion params based on context it is used
