...
type UploadTaskWhereInput struct {
	...
	// current chunk
	CurrentChunk *float64 `json:"current_chunk,omitempty"`

	// current chunk gt
	CurrentChunkGt *float64 `json:"current_chunk_gt,omitempty"`

	// current chunk gte
	CurrentChunkGte *float64 `json:"current_chunk_gte,omitempty"`

	// current chunk in
	CurrentChunkIn []float64 `json:"current_chunk_in,omitempty"`

	// current chunk lt
	CurrentChunkLt *float64 `json:"current_chunk_lt,omitempty"`

	// current chunk lte
	CurrentChunkLte *float64 `json:"current_chunk_lte,omitempty"`

	// current chunk not
	CurrentChunkNot *float64 `json:"current_chunk_not,omitempty"`

	// current chunk not in
	CurrentChunkNotIn []float64 `json:"current_chunk_not_in,omitempty"`
