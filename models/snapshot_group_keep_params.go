...
func (m *SnapshotGroupKeepParams) validateID(formats strfmt.Registry) error {
...
// ContextValidate validates this snapshot group keep params based on context it is used
