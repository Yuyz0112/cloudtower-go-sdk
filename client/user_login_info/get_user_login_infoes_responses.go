...
func (o *GetUserLoginInfoesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetUserLoginInfoesOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 400:
		result := NewGetUserLoginInfoesBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *GetUserLoginInfoesOK) Error() string {
	return fmt.Sprintf("[POST /get-user-login-infoes][%d] getUserLoginInfoesOK  %+v", 200, o.Payload)
}
func (o *GetUserLoginInfoesOK) GetPayload() []*models.UserLoginInfo {
	return o.Payload
}

func (o *GetUserLoginInfoesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetUserLoginInfoesBadRequest() *GetUserLoginInfoesBadRequest {
	return &GetUserLoginInfoesBadRequest{}
}
...
func (o *GetUserLoginInfoesBadRequest) Error() string {
	return fmt.Sprintf("[POST /get-user-login-infoes][%d] getUserLoginInfoesBadRequest  %+v", 400, o.Payload)
}
func (o *GetUserLoginInfoesBadRequest) GetPayload() string {
	return o.Payload
}

func (o *GetUserLoginInfoesBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
