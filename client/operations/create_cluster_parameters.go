...
// WithRequestBody adds the requestBody to the create cluster params
func (o *CreateClusterParams) WithRequestBody(requestBody []*models.ClusterCreationParams) *CreateClusterParams {
	o.SetRequestBody(requestBody)
	return o
}

// SetRequestBody adds the requestBody to the create cluster params
func (o *CreateClusterParams) SetRequestBody(requestBody []*models.ClusterCreationParams) {
